...
public class PinChange extends JFrame implements ActionListener {
    ...
    text.setBounds(380, 350,180, 20);
    image.add(text);
    
    JLabel pintext = new JLabel("New Pin:");
    pintext.setForeground(Color.WHITE);
    pintext.setFont(new Font("System",Font.BOLD, 16));
    pintext.setBounds(280,400,180,25);
    image.add(pintext);
    
    pin = new JPasswordField();
    pin.setFont(new Font("Raleway", Font.BOLD, 25));
    pin.setBounds(420, 400, 180, 25);
    image.add(pin);
    
    JLabel repintext = new JLabel("Re-Enter New Pin: ");
    repintext.setForeground(Color.WHITE);
    repintext.setFont(new Font("System",Font.BOLD, 16));
    repintext.setBounds(280,440,180,25);
    image.add(repintext);
    
    repin = new JPasswordField();
    repin.setFont(new Font("Raleway", Font.BOLD, 25));
    repin.setBounds(420, 440, 180, 25);
    image.add(repin);
    
    change = new JButton ("Change");
    change.setBounds(450,485,150,30);
    change.addActionListener(this);
    image.add(change);
    
    back = new JButton ("Back");
    back.setBounds(450,520,150,30);
     ...
     public void actionPerformed(ActionEvent ae){
            if (ae.getSource()== change){
                try{
                    ...
                    String query3 = "update signuptwo set pin ='"+rpin+"' where cardnumber = '"+cardnumber+"'";
